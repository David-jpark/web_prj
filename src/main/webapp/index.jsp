                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                 ...
                                 <!--  --------------로그인 / 로그아웃 처리 --------다른 jsp에 대해 일괄처리를 해야함(include)-->
										<%
                ...
                <main>
                    <div class="container-fluid px-4">
						...
						if(grade != null){
							...
							if(grade.equals("u")) {
								out.println("사용자 접속 : " +uname );
							} else if(grade.equals("a")) {
								out.println("관리자 접속 : " +uname );
							} else {
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="https://img.khan.co.kr/news/2023/12/31/l_2024010101000021800103831.jpg" >View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
