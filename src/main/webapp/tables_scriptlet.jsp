                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <!--  --------------로그인 / 로그아웃 ---------------  다른 jsp에 대해 일괄처리를 해야함(include)-->
                    ...
                    <div class="container-fluid px-4">
                       ...
                       <a class="nav-link" href="${pageContext.request.contextPath}/BoardServlet">
                        ...
                        <div class="card mb-4">
                   		...
                   		<c:set var ="varList" value= "${requestScope.KEY_BOARDLIST}"></c:set>
                   		 		총:${fn:length(KEY_BOARDLIST)} 건
                   		<c:forEach items ="${varList}" var="bvo">
						 ${bvo.seq}, ${bvo.regid}, ${bvo.title}, ${bvo.Contents}, ${bvo.Regid}, ${bvo.Regdate} <br>
						</c:forEach>
